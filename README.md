...
- 7 console themes: Game Boy, GB Color, NES, Super NES, Switch, Famicom (THEME button) – your choice is remembered, including unlockable Virtual Boy
...
TOP: THEME cycles 7 console looks (Game Boy, GB Color, NES, SNES, Switch, Famicom; saved). GAME opens the game menu. SND toggles 8-bit sounds.
